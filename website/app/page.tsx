        ...
        <div className="max-w-2xl mx-auto bg-[#111] border border-white/10 rounded-2xl overflow-hidden">
          ...
          <div className="p-5 font-[family-name:var(--font-mono)] text-sm space-y-1.5">
            <p>
              ...
              <span className="text-white">npx dev-audit scan</span>
            </p>
            ...
            <p className="text-white/60">
              &nbsp; → DELETE&nbsp; /api/old-session&nbsp;&nbsp;&nbsp;
              (src/routes.ts:41)
            </p>
            <p className="text-white/40">&nbsp;</p>
            <p className="text-white/50">
              Review these endpoints — they may be legacy code that can be
              removed.
            </p>
          </div>
        </div>
          ...
          <div className="grid sm:grid-cols-3 gap-5">
            <div className="bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-emerald-400/30 transition-colors">
              ...
              <p className="text-sm text-white/50 leading-relaxed">
                Scans your backend routes and cross-references them against
                frontend calls. Flags anything that&apos;s never used.
              </p>
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-emerald-400/30 transition-colors">
              ...
              <p className="text-sm text-white/50 leading-relaxed">
                Detects your project stack automatically and generates a
                tailored{" "}
                <code className="text-white/70 text-xs">.gitignore</code> — no
                more copy-pasting from the internet.
              </p>
              <div className="mt-4 flex flex-wrap gap-2">
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-emerald-400/30 transition-colors">
              ...
              <p className="text-sm text-white/50 leading-relaxed">
                Point it at your TypeScript types and get a running mock server
                with realistic fake data. Frontend-first development, unblocked.
              </p>
              <div className="mt-4 flex flex-wrap gap-2">
      ...
      <section className="px-6 pb-24">
        <div className="max-w-3xl mx-auto bg-emerald-400/5 border border-emerald-400/20 rounded-2xl p-8">
          ...
          <p className="text-white/50 text-sm mb-6 leading-relaxed">
            dev-audit runs entirely on your machine. Your code never leaves your
            terminal.
          </p>
      ...
      <section className="px-6 pb-24 text-center">
        <div className="max-w-xl mx-auto">
          ...
          <p className="text-white/50 text-sm mb-8">
            dev-audit is MIT licensed. Contributions, bug reports, and feature
